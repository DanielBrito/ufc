...
\begin{figure}
  ...
  \scalebox{1.0}{
    \begin{tikzpicture}[domain=0:8]
      ...
      \draw[very thin, color=red, smooth] plot (\x, {0.26*\x*\x - 1.89*\x +2.175}) node[right] {$p(x)$};
    \end{tikzpicture}
  }
...
\begin{figure}
  ...
  \scalebox{1.0}{
    \begin{tikzpicture}[domain=0:8]
      ...
      \draw[domain = 0:7.1, very thin, color=red, smooth] plot (\x, {-1}) node[right] {$p_1(x)$};
      \draw[domain = 0:6.2, very thin, color=orange, smooth] plot (\x, {-1 + 0.5*(\x - 3.14159)^2}) node[right] {$p_2(x)$};
      \draw[domain = 0:6.5, very thin, color=purple, smooth] plot (\x, {-1 + 0.5*(\x - 3.14159)^2 - 0.04166*(\x - 3.14159)^4}) node[right] {$p_3(x)$};
    \end{tikzpicture}
  }
...
\begin{figure}
  ...
  \scalebox{1.0}{
    \begin{tikzpicture}[domain=0:8]
      ...
      \draw[domain = 0:7.1, very thin, color=red, smooth] plot (\x, {sin(1 r) + ((sin(4 r) - sin(1 r))/3)*(\x - 1)}) node[right] {$r_1(x)$};
      \draw[domain = 0:7.1, very thin, color=purple, smooth] plot (\x, {sin(2.5794 r) + ((sin(4 r) - sin(2.5794 r))/(4 - 2.5794))*(\x - 2.5794)}) node[right] {$r_2(x)$};
      % \draw[domain = 0:6.2, very thin, color=orange, smooth] plot (\x, {-1 + 0.5*(\x - 3.14159)^2}) node[right] {$p_2(x)$};
      % \draw[domain = 0:6.5, very thin, color=purple, smooth] plot (\x, {-1 + 0.5*(\x - 3.14159)^2 - 0.04166*(\x - 3.14159)^4}) node[right] {$p_3(x)$};
    \end{tikzpicture}
  }
