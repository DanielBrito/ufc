...
\begin{figure}
  ...
  \scalebox{1.0}{
    \begin{tikzpicture}[domain=0:8,
      ...
      % dois subintervalos
      \draw[ultra thin, color=orange, smooth] (1, {f(1)}) -- (2.5, {f(2.5)});
      \draw[ultra thin, color=orange, smooth] (2.5, {f(2.5)}) -- (4, {f(4)});

      % quatro subintervalos
      \draw[ultra thin, color=purple, smooth] (1, {f(1)}) -- (1.75, {f(1.75)});
      \draw[ultra thin, color=purple, smooth] (1.75, {f(1.75)}) -- (2.5, {f(2.5)});
      \draw[ultra thin, color=purple, smooth] (2.5, {f(2.5)}) -- (3.25, {f(3.25)});
      \draw[ultra thin, color=purple, smooth] (3.25, {f(3.25)}) -- (4, {f(4)});
    \end{tikzpicture}
  }
